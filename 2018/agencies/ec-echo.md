...
It publishes in the IATI standard on a monthly basis.
...
Information on project attributes indicators is generally made available although subnatinal locations and implementers are the lowest scoring ones. 
...
EC-ECHO does well on basic joined-up development data indicators such as aid type, finance type, flow type or tied aid status. While made available in the IATI format, tenders were outdated and could only be found osmetimes elsewhere. Contracts are not being made available in IATI but are made available in other formats. 
